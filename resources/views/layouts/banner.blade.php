...
style="background-image: url('{{ asset($header?$header->banner:'assets/uploads/7367b8fb/_.jpg') }}');"></div>
<div class="home__searchbar">
    <div class="searchbar searchbar--hide-on-mobile">
        <div class="searchbar__bg"></div>
        <div class="searchbar-inner clearfix">
            <?php 
                $url = "http://maceshub.com/api/product/count-products";
                $totalProducts = CH::callAPI($url);
            ?>
            <p class="searchbar__header">Total Cars in Stock: {{$totalProducts}}</p>
                ...
                <div class="searchbar__selects-container">
                    ...
                    <div class="searchbar__select-container searchbar__select-container--large">
                        ...
                        <select name="drive_type" id="drivetrain" class="searchbar__select" title="Drivetrain(any)">
                            <option selected value>Drivetrain(any)</option>
